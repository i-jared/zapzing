            ...
            <div className="flex items-center justify-center py-8">
              <div className="text-center opacity-50">
                ...
                <div className="text-sm text-base-content/70">
                  Send the first message to {isDirectMessage ? "@" : "#"}
                  {channelName}
                </div>
              </div>
            </div>
                    ...
                    <div className="text-base-content relative">
                      ...
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity items-center gap-2 absolute -top-12 right-8 bg-base-200 rounded-full p-2 shadow-lg z-[10] flex pointer-events-none group-hover:pointer-events-auto">
                        ...
                        <div className="dropdown dropdown-end">
                          <label
                            tabIndex={0}
                            className="btn btn-ghost btn-sm px-2 min-h-0 h-8 flex items-center justify-center"
                          >
                            <FaSmile className="w-5 h-5 text-base-content" />
                          </label>
                          <div
                            tabIndex={0}
                            className="dropdown-content z-[50] shadow-lg"
                          >
                            <Picker
                              data={data}
                              onEmojiSelect={(emoji: any) =>
                                handleAddReaction(msg.id, emoji.native)
                              }
                              theme="auto"
                              categories={[
                                "frequent",
